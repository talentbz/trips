...
@section('page-title') Edit Daily Trip @endsection
@section('css')
                                    ...
                                    <div class = "row">
                                        <div class = "col-md-6">
                                            ...
                                            <div class="input-group" id="datepicker1">
                                                <input type="text" class="form-control" placeholder="yyyy-mm-dd"
                                                    ...
                                                    data-provide="datepicker" name="start_trip_date" value="{{$daily_trip->start_date}}" required>
                                        ...
                                        <div class = "col-md-6">
                                            ...
                                            <div class="input-group" id="timepicker-input-group1">
                                                <input id="timepicker" type="text" class="form-control" data-provide="timepicker" value="{{$daily_trip->start_time}}" name = "start_trip_time">
                                ...
                                <div class = "mb-3">
                                    <div class = "row">
                                        ...
                                        <div class = "col-md-6">
                                            ...
                                            <div class="input-group" id="timepicker-input-group1">
                                                <input id="timepicker" type="text" class="form-control" data-provide="timepicker" value="{{$daily_trip->end_time}}" name = "end_trip_time">
                                                <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                            </div>                                            
                                        </div>
                                    </div>
                                ...
                                <div class = "mb-3">
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_1" value="1" {{$daily_trip->status == 1 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_2" value="2" {{$daily_trip->status == 2 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_3" value="3" {{$daily_trip->status == 3 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_4" value="4" {{$daily_trip->status == 4 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_5" value="5" {{$daily_trip->status == 5 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_6" value="6" {{$daily_trip->status == 6 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_7" value="7" {{$daily_trip->status == 7 ? "checked" : ""}}>
                                    ...
                                    <div class="form-check form-radio-warning">
                                        <input class="form-check-input" type="radio" name="status"
                                            id="status_8" value="8" {{$daily_trip->status == 8 ? "checked" : ""}}>

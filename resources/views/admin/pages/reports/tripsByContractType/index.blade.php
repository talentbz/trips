...
@section('title') Trips Report By Contract Type @endsection
@section('page-title') Trips Report By Contract Type @endsection
@section('css')
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class = "row mb-5">
                                <div class = "col-md-2 mt-4">
                                    <select class="form-select" name="client_filter">
                                        <option>All Contract Type</option>
                                            <option value=""></option>
                        ...
                        <div class="table-wrapper">
                           @include('admin.pages.reports.tripsByContractType.table')
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->

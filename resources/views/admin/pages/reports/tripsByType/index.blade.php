...
@section('title') Trips Report By Trip Type @endsection
@section('page-title') Trips Report By Trip Type @endsection
@section('css')
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-wrapper">
                           @include('admin.pages.reports.tripsByType.table')
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
